...
hazar_et_al = ElasticPlasticTransformMaterial(E=200.5e3, v=0.27, sy0M=10000*1016, sy0A=420., Q=180., b=100.,
                                              Cm=np.array([135e3, 700e3, 50e3]),
                                              gamma_m=np.array([950., 500., 50.]),
                                              a=0.0677272727272727*np.array([1., 0., 0.]),
                                              Ms=220, name='SKF', Mss=-104.13818181818179, fM=0.78,
                                              beta=0*58.39, alpha=126.61, n=4., sde=0.0, g0=60, g1=0*176000, g2=5.2,
                                              g_mean=57, g_std=350)
hazar_et_al.k = 0.01
hazar_et_al.dV = 0.0371
hazar_et_al.R1 = 0*-0.07032324+0.07
hazar_et_al.R2 = .060258890*0+0.02*0
