...
hazar_et_al = ElasticPlasticTransformMaterial(E=200.5e3, v=0.27, sy0M=1016, sy0A=420., Q=180., b=100.,
                                              ...
                                              a=0.003325945755266598*np.array([1., 0., 0.]),
                                              Ms=220, name='SKF', Mss=-45.599889811989115, fM=0.78,
                                              beta=500521.2142995694604, alpha=129.98359086303265, n=4., sde=0.04,
                                              g0=14.361769920692034,
                                              g1=60.62406811305142, g2=0, g_mean=0, g_std=18.056870261724143,
                                              fsb0=0.11879158373330523)
hazar_et_al.k = 0.01
hazar_et_al.dV = 0.023452268954649524
hazar_et_al.R1 = 0.01599183565870769
hazar_et_al.R2 = 0.00793495890945268
parameters = {'beta': 500, 'alpha': 200, 'a1': 0.05, 'Mss': -86., 'fsb0': 0.1,
              'R1': 0.01, 'R2': 0.005, 'dV': 0.037, 'g1': 50,
              'g_std': 10, 'g0': 10}
"""
R1=0.01599183565870769, 
   R2=0.00793495890945268, 
   g0=14.361769920692034, 
   Mss=-45.599889811989115, 
   a1=0.003325945755266598, 
   beta=521.2142995694604, 
   fsb0=0.11879158373330523, 
   g_std=18.056870261724143, 
   alpha=129.98359086303265, 
   g1=60.62406811305142, 
   dV=0.023452268954649524,
"""
# Hazar et. al
# Temperature   beta
# 22            ??
