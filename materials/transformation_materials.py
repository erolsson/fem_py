...
SS2506 = ElasticPlasticTransformMaterial(E=200.5e3, v=0.27, sy0M=1016, sy0A=420., Q=180., b=100.,
                                         ...
                                         Ms=166.69903883197608, name='SKF', Mss=-48.194154926470915, fM=0.78,
                                         beta=306.6016112399211, alpha=115.6731692918583, n=4., sde=0.04,
                                         g0=3.077651873747456,
                                         g1=68.83381914607745, g2=0, g_mean=0, g_std=29.5540022577844,
                                         fsb0=0.22758101605717712)

SS2506.k = 0.01137006469685866
