...
neu_sehitoglu = ElasticPlasticTransformMaterial(E=200e3, v=0.3, sy0M=100000., sy0A=1000., Q=2100., b=100.,
                                                Cm=0*np.array([15432, 281622, 470894]),
                                                gamma_m=0*np.array([5., 236., 2301.]), a=np.array([0.056/3, 0*0.028, 0.]),
