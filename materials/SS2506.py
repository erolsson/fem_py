...
class ElasticPlasticTransformMaterial:
    ...
    def umat_parameters(self):
        ...
        return parameters + kinematic_hardening_params + [self.R1, self.R2] + [self.Ms, self.Mss, self.k,
...
neu_sehitoglu = ElasticPlasticTransformMaterial(E=200e3, v=0.3, sy0M=1000., sy0A=420, Q=0*180., b=100.,
                                                Cm=np.array([15432, 281622, 470894]),
                                                gamma_m=np.array([5., 236., 2301.]), a=[0.056, 0.028, 0.],
