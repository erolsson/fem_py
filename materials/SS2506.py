...
neu_sehitoglu = ElasticPlasticTransformMaterial(E=200e3, v=0.3, sy0M=10000000000., sy0A=1000., Q=0*580., b=100.,
                                                Cm=np.array([15432, 281622, 470894]),
                                                gamma_m=np.array([5., 236., 2301.]), a=np.array([0.056/3, 0*0.028, 0.]),
