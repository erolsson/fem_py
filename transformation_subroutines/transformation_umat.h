...
extern "C" void umat_(double *stress, double *statev, double *ddsdde, double *sse, double *spd, double *scd,
                      ...
                      char *cmname, const int *ndi, const int *nshr, const int *ntens, const int *nstatv,
                      const double* props, const int *nprops, double *coords, double *drot, double *pnewdt,
                      double *celent, double *dfgrd0, double *dfgrd1, const int *noel, const int *npt,
