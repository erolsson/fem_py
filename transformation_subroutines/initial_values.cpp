...
extern "C" void getpartinfo_(const int* intnum, const int* jtype, char* cpname, int* locnum, int* jrcd);
...
extern "C" void sdvini_(double* statev, const double* coords, const int* nstatev, const int* ncrds, const int* noel,
    ...
    int jtype = 1;
    {
        ...
        getpartinfo_(noel, &jtype, part_name_ptr, &user_elem_number, &error);
