...
extern "C" void getpartinfo_(const int* intnum, int jtype, char* cpname, int*, int* locnum, int* jrcd);
...
extern "C" void sdvini_(double* statev, const double* coords, const int* nstatev, const int* ncrds, const int* noel,
    ...
    const int jtype = 1;
    {
        ...
        getpartinfo_(noel, 1, part_name_char, &part_name_len, &user_elem_number, &error);
