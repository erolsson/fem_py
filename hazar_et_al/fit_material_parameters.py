...
def residual(par, *data):
    ...
    for experiment in experiment_list:
        ...
        if experiment.volume_expansion is not None:
            ...
            e_vol = np.interp(experiment.volume_expansion[:, 0], inelastic_strain, e_fem)
...
if __name__ == '__main__':
    parameters = {'R1': 1.71425621e-02, 'R2:': 1.23645999e-03, 'beta': 1.20879577e+02, 'alpha': 1.66852984e+02,
                  'fsb0': 8.45394348e-02}
